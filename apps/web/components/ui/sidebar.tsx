...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-0 overflow-auto group-data-[collapsible=icon]:overflow-hidden [scrollbar-color:var(--sidebar-border)_transparent] [scrollbar-width:thin]",
        className
      )}
      {...props}
    />
