...
const DIRECTORY_NAMES = {
  ...
  grcData: "grc-data",
  grcDataRisks: path.join("grc-data", "risks"),
  grcDataMetrics: path.join("grc-data", "metrics"),
  grcDataMetricSnapshots: path.join("grc-data", "metrics", "snapshots"),
  grcDataExceptions: path.join("grc-data", "exceptions"),
  grcDataVendors: path.join("grc-data", "vendors"),
  grcDataPolicies: path.join("grc-data", "policies"),
  grcDataControls: path.join("grc-data", "controls"),
...
grcDataPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcData),
    grcDataRisksPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataRisks),
    grcDataMetricsPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataMetrics),
    grcDataMetricSnapshotsPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataMetricSnapshots),
    grcDataExceptionsPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataExceptions),
    grcDataVendorsPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataVendors),
    grcDataPoliciesPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataPolicies),
    grcDataControlsPath: path.join(resolvedRootPath, DIRECTORY_NAMES.grcDataControls),
...
async function createWorkspaceDirectories(rootPath) {
  ...
  await Promise.all([
    ...
    fs.mkdir(folders.grcDataPath, { recursive: true }),
    fs.mkdir(folders.grcDataRisksPath, { recursive: true }),
    fs.mkdir(folders.grcDataMetricsPath, { recursive: true }),
    fs.mkdir(folders.grcDataMetricSnapshotsPath, { recursive: true }),
    fs.mkdir(folders.grcDataExceptionsPath, { recursive: true }),
    fs.mkdir(folders.grcDataVendorsPath, { recursive: true }),
    fs.mkdir(folders.grcDataPoliciesPath, { recursive: true }),
    fs.mkdir(folders.grcDataControlsPath, { recursive: true }),
...
dataRoot: folders.dataRootPath,
      ...
      program: folders.grcDataPath,
      programRisks: folders.grcDataRisksPath,
      programMetrics: folders.grcDataMetricsPath,
      programMetricSnapshots: folders.grcDataMetricSnapshotsPath,
      programExceptions: folders.grcDataExceptionsPath,
      programVendors: folders.grcDataVendorsPath,
      programPolicies: folders.grcDataPoliciesPath,
      programControls: folders.grcDataControlsPath,
